...
function passive(){
  ...
  game.currency.existance=1/(1+Math.exp(game.currency.existance));
  ...
  if (game.unlocked.existivity){document.getElementById("disp.existivity").innerHTML="Your existivity is <span class=\"large\">"+Math.round(game.currency.existivity*10)/10+"</span> and has <span class=\"large\">"+Math.round(game.currency.existance*1000)/10+"%</span> change of existing.";}
