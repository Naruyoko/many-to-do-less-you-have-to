  ...
  for (var y=0;y<game.achievement.arrangement.length;y++){
    for (var x=0;x<game.achievement.arrangement[y].length;x++){
      ...
      if (a!=-1){
        ...
        if (game.option.achievementimages()) o.innerHTML+="<img src=\"./files/pictures/achievements/"+game.achievement.arrangement[y][x]+".png\" style=\"display:relative;margin:auto;opacity:0.6\">";
